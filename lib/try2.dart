        ...
        child: SizedBox(height: 880, child: Container(
            ...
            children: [
                ...
                Row(
                      ...
                      Text(
                          '\$${cartItems.map((item) => item.totalPrice).reduce((a, b) => a + b).toStringAsFixed(2)}'),
                      Text(
                        "تكلفة الشراء",
                        style: TextStyle(
                          fontFamily: 'Avenir',
                ...
                Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text(
                      "\$${(cartItems.map((item) => item.totalPrice).reduce((a, b) => a + b) * tax).toStringAsFixed(2)}"
                  ),
                  Text(
                    "الضريبة",
                    style: TextStyle(
